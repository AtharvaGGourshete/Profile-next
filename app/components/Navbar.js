...
const Navbar = () => {
  ...
  return (
    <nav className="justify-between">
      <ul className="flex bg-gray-950 text-white justify-between item-center align-center h-20 space-center text-lg ">
        ...
        <li>
          <Link href={"/login"}>
            <button className="mt-4 text-red hover:before:bg-redborder-red-500 relative h-[50px] w-40 overflow-hidden border border-blue-600 px-3 text-white-500 shadow-2xl transition-all before:absolute before:bottom-0 before:left-0 before:top-0 before:z-0 before:h-full before:w-0 before:bg-blue-500 before:transition-all before:duration-500 hover:text-white hover:text-2xl hover:shadow-blue-500 hover:before:left-0 hover:before:w-full mx-4 hover:text-black">
